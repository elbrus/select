...
if (_propTypes2['default']) {
  valueObjectShape = _propTypes2['default'].oneOfType([_propTypes2['default'].string, _propTypes2['default'].number, _propTypes2['default'].object, _propTypes2['default'].shape({
...
var Select = (0, _createReactClass2['default'])({
  propTypes: {
    ...
    filterCaseSensitive: _propTypes2['default'].bool,
