...
function filterFn(input, child) {
  var _props = this.props,
      filterCaseSensitive = _props.filterCaseSensitive,
      optionFilterProp = _props.optionFilterProp;

  var value = String((0, _util.getPropValue)(child, optionFilterProp));
...
if (_react.PropTypes) {
  valueObjectShape = _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number, _react.PropTypes.object, _react.PropTypes.shape({
...
var Select = _react2["default"].createClass({
  ...
  propTypes: {
    ...
    filterCaseSensitive: _react.PropTypes.bool,
  ...
  getInputElement: function getInputElement() {
    ...
    var inputCls = (0, _classnames3["default"])(inputElement.props.className, _defineProperty({}, props.prefixCls + '-search__field', true));
    return _react2["default"].createElement(
      'div',
